...
export default function Interlude() {
  ...
  return (
    <div className="relative min-h-[70vh] flex items-center justify-center text-center px-5 md:px-10 py-16 md:py-24 overflow-x-hidden">
      <div
      ...
      <div className="relative z-10">
        <h2
          ...
          style={{ fontSize: 'clamp(2rem, 8vw, 7rem)', letterSpacing: '-3px', lineHeight: 1.15 }}
        >
          {t('h2Line1')} <em style={{
