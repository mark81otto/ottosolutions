...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 md:py-40 px-5 md:px-10 bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-32 items-start">
        <div>
          ...
          <p className="text-[0.95rem] font-light text-mid leading-[1.8] mb-10 md:mb-12">{t('lead')}</p>
        ...
        <form className="flex flex-col gap-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <input
              ...
              className="w-full font-sans font-light text-[0.875rem] px-4 py-3.5 rounded-xl outline-none bg-[#f9f8f6] text-ink border border-transparent focus:border-[rgba(110,93,221,0.3)] focus:shadow-[0_0_0_4px_rgba(110,93,221,0.06)] focus:bg-white transition-all placeholder:text-mid min-h-[44px]"
            />
            <input
          ...
          <select
            defaultValue=""
            className="w-full font-sans font-light text-[0.875rem] px-4 py-3.5 rounded-xl outline-none bg-[#f9f8f6] text-mid border border-transparent focus:border-[rgba(110,93,221,0.3)] focus:bg-white transition-all appearance-none cursor-pointer min-h-[44px]"
          >
          ...
          <button
            type="submit"
            className="font-sans font-medium text-[0.9rem] py-4 bg-ink text-white rounded-xl flex items-center justify-center gap-2 hover:opacity-88 hover:-translate-y-0.5 transition-all group min-h-[44px]"
          >
            {t('submit')}
