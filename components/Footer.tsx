    ...
    <footer className="footer-root">
      <div className="footer-grid">
        ...
        <div className="footer-col footer-col-brand">
          <img
            src="/logo.png"
            alt="Otto Solutions SL"
            className="footer-logo"
          />
          <p className="footer-tagline">{t('tagline')}</p>
          <div className="footer-social">
            <a
              href="https://www.linkedin.com/company/otto-solutions-sl"
              target="_blank"
            ...
            <a
              href="https://github.com/otto-solutions"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="footer-social-link"
            ...
            <a
              href="https://www.instagram.com/ottosolutions"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="footer-col">
          <h4 className="footer-col-title">{t('servicesTitle')}</h4>
          <nav className="footer-nav">
            <a href="/#services" className="footer-nav-link">{t('service1')}</a>
            <a href="/#services" className="footer-nav-link">{t('service2')}</a>
            <a href="/#services" className="footer-nav-link">{t('service3')}</a>
          </nav>
        </div>
